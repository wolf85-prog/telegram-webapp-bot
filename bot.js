...
Внимание! 
Ваше предложение может повлиять на конверсию и оперативный поиск специалистов если:
• Ставка ниже рыночной;
• Техническое задание другой коэффициент;
• Повышенный спрос на даты проекта;
Поиск специалистов может занять больше времени. Компетенции, или качество специалистов могут оказаться низкими.`}})
