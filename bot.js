    ...
    try {
            await bot.answerWebAppQuery(queryId, {
                ...
                input_message_content: {
                    parse_mode: 'HTML',
                    message_text: 
`Новая ставка отправлена на модерацию!\n Внимание! Ваше предложение может повлиять на конверсию и оперативный поиск специалистов если:
• Ставка ниже рыночной;
• Техническое задание другой коэффициент;
• Повышенный спрос на даты проекта;
В этом случае поиск специалистов может занять больше времени, компетенции или качество специалистов могут оказаться низкими.`}})
